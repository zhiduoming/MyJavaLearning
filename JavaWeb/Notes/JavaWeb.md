...
现在的主要开发模式就是前后端分离开发，当感觉越来越偏向全栈开发了，前端已经被淘汰了（开除的速度一定要快！已经有人截屏了！），我也要主要学习全栈开发，将来还要结合AI，做到AI➕全栈开发，也要掌握vibe coding的技能。



### 接口文档

在传统前后端开发模式中，为了避免前后端结合产生的一些不便，不统一，需要来撰写项目的接口文档，里面要详细记录接口的具体实现方式，也就是功能的具体实现标准，尽可能详细规范，尽量给出样例。后面做项目，我还要去学着写接口文档。。。



### 开发规范

传统风格URL和RESTful开发风格的URL，传统风格的请求方式比较单一，只有GET和POST，看着还算清晰，但是通过增删改查的各种动词也要写在URL中，导致有可能统一个项目很多人开发时造成的URL不统一，而REST风格的URL则避免了这个问题，它将请求方式进行了扩充，在url中只写具体的信息，而不加入请求方式，请求方式单另出来，这样就可以使得URL规范统一。



<img src="./images/image-20260413214440951.png" alt="image-20260413214440951" style="zoom:67%;" />

![image-20260413214637001](./images/image-20260413214637001.png)
